# 📝 Задача: Система анализа логов веб-сервера
...
### Уровень 3 (Продвинутый - 20 минут)
...
- `log_analyzer_advanced.py` - streaming, async, фильтры
- `log_visualizer.py` - генерация отчетов и графиков
